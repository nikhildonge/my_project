...
<body>
    <h1>Login Page</h1>
     ...
     <div style="text-align: center;" id="loginDiv">
	    ...
	    <button type="submit" style="text-align: center;" class="" onclick="userLogin();">Login</button><br><br>
	    
	    <div><a id="Clickreg">Click here to register!</a></div>
	    </form>
    </div>
    ...
    function saveUserData() {
        ...
        form.addEventListener('submit', function (e) {
            ...
            console.log("formObj: ", formObj);
             ...
             $.ajax({
                 url: "${pageContext.request.contextPath}/abc/saveUser",
                 method: "POST",
    ...
    function userLogin() {
    	let postParameter ={
			...
			alert("postParameter :"+JSON.stringify(postParameter));

             $.ajax({
                 url: "${pageContext.request.contextPath}/abc/login",
                 method: "POST",
...
return;
                	    Swal.fire({
                	        title: 'Login',
                	        icon: 'success',
                	        text: response, // Use 'text' instead of 'html' for a plain message
                	        confirmButtonText: 'OK',
                	        allowEnterKey: true,
                	        allowEscapeKey: true,
                	    });
